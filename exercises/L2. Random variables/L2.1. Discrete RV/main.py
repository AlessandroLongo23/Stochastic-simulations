...
def part1() -> None:
    ...
    evaluator = Evaluator()
    evaluator.run_GOF_tests(generators = [geometric], n = 10000, simulations = 1, classes = 100)
...
def part2() -> None:
    ...
    evaluator.run_GOF_tests(generators = generators, n = 1000, simulations = 1000, savepath = 'GOF_tests.png')
